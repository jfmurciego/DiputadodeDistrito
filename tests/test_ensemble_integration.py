...
class IntegratedRunnerTests(unittest.TestCase):
    ...
    def test_workflow_has_single_visible_entry_and_five_profile_parallelism(self):
        ...
        self.assertNotIn("actions/deploy-pages@d6db90164ac5ed86f2b6aed7e0febac5b3c0c03e", workflow)
        self.assertIn("uses: ./.github/workflows/_reutilizable-publicar-sitio.yml", workflow)
        self.assertIn("ensemble_release_tag:", workflow)
