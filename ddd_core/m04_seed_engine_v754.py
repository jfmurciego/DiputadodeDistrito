...
VERSIÓN: 7.5.4
NOMBRE: Puerta mínima y normalización secuencial robusta
FECHA: 2026-09-11
...
CAMBIOS: usa postproceso v7.4.9 y normaliza arrays/tuplas unitarios antes de exportar.\nANTERIOR: ddd_core/m04_seed_engine_v753.py
"""
...
POST_PATH=ROOT/'ddd_core'/'m04_seed_engine_v749.py'
...
def _normalize_unit_property_for_ogr(path):
    ...
    for feature in data.get('features',[]):
        ...
        if isinstance(value,list):
            if len(value)!=1:
                raise SystemExit(f'M04 v7.5.4: ddd_unit_id multivaluado no normalizable: {value!r}')
...
def main():
    ...
    base=_load(BASE_PATH,'ddd_m04_seed_engine_v745_for_v754')
    ...
    post=_load(POST_PATH,'ddd_m04_seed_engine_v747_post_for_v754')
