...
def build_inventory(evidence_root: Path, context: dict) -> dict:
    ...
    deployment_status = get_any(publication, "deployment_status") or publication_status
    territorial_certification_status = get_any(production_status, "territorial_certification_status") or get_any(production_status, "decision")
