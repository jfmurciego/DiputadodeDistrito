...
VERSIÓN: 1.0.2
NOMBRE: Reparación de propiedad GeoJSON sin OGR — diagnóstico M05 v7.4.2
FECHA: 2026-09-11
...
CAMBIOS: sin cambio funcional; actualiza trazabilidad al wrapper M05 v7.4.2, que resuelve rutas canónicamente y dispone de fallback interno a IDs enteros OGR-safe.
MOTIVO: disparar y documentar la prueba EXT-03 sobre el wrapper corregido sin introducir lógica nueva.
ANTERIOR: legacy/herramientas/reparar_propiedad_geojson_zip_v1.0.1.py
"""
