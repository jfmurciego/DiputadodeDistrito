...
ESTADO: legacy desde CYL-03.
CAMBIOS: copia exacta de la versión vigente antes de generalizar la regla de municipios sobredimensionados.
MOTIVO: preservar trazabilidad antes de M04 v7.4.0.
...
def main():
    ...
    print(f'[Módulo 4] OK v7.3.1 K={K} provincias={prov_counts} hard=0 min={int(pops.min())} max={int(pops.max())} out={out}')
