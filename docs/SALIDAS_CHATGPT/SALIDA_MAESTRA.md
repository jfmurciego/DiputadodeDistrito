...
`HITOS/2026-09-12_F105_CERRADA.md`

## Estado operativo

- Aragón: PASS.
- Castilla y León: PASS.
- Extremadura: cierre formal `EXPERIMENTAL_BLOCKED`; no promovida.
- F1.5: cerrada; smoke y ambas regresiones verdes.
...
Leer esta salida, el último hito y el plan cerrado. No lanzar otras comunidades.
