...
- reutilizables operativos: `_reutilizable-operacion-territorial.yml`, `_reutilizable-auditoria-topologica.yml`, `producir-territorio-por-contrato.yml`, `generar-alternativas-territoriales.yml`, `desplegar-visor-publico.yml`, `orquestacion-control.yml`, `orquestacion-durable.yml`;
